...
const TransactionManager = () => {
  ...
  if (userEmail !== "All") {
    const findBranchBooking = branchBooking?.filter(
    ...
    for (const item of branchBooking) {
      totalBookingAmount += item.totalAmount;
    }
  }
            ...
            <div className="d-none">
              <div ref={ref}>
                ...
                <Table striped bordered responsive>
                  ...
                  <tbody>
                    {managerTransaction.map((transaction) => (
