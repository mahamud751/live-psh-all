...
const InvoiceForMobile = ({ pdfRef }) => {
  ...
  const downloadPDF = () => {
    ...
    // let downloadInput = <InvoiceForMobile />;
    // console.log((pdfRef.current = <InvoiceForMobile />));
  ...
  return (
    <div ref={pdfRef}>
      <div className=" md:p-10 sm:p-2 mt-5 payment-info border">
        <div className="flex md:justify-between sm:justify-normal md:gap-x-0 sm:gap-x-16 ">
          ...
          <div className="text-right">
            <h2 className="text-[28px] font-[500] text-[#35B0A7]">INVOICE</h2>
        ...
        {/* Booking Location */}
        <div className="flex md:justify-between sm:justify-normal md:gap-x-0 sm:gap-x-3 mt-10 text-left">
          <div>
          ...
          <div>
            <div className="text-left ">
              ...
              <p>
                <span className="font-bold">Email :</span> {userEndOrder?.email}
              </p>
        ...
        <div>
          ...
          >
            <div className="grid xl:gird-cols-2 lg:grid-cols-2 md:grid-cols-2 py-1.5 px-3">
              <div className="flex col-span-1 items-center font-medium">
                <p>01.</p>
                {userEndOrder?.bookingInfo?.roomType === "Shared Room" ? (
                  <p className="ml-10">
                    {userEndOrder?.bookingInfo?.roomName +
                      ", Room Number : " +
                      userEndOrder?.bookingInfo?.roomNumber +
                      ", Seat Number : " +
                      userEndOrder?.bookingInfo?.seatBooking?.seatNumber}
                  </p>
                ) : (
                  <p className="ml-10">
              ...
              <div className="flex items-center justify-between">
                <p>
                  {userEndOrder?.bookingInfo?.customerRent?.daysDifference >= 0
                    ...
                    : "" ||
                      (userEndOrder?.bookingInfo?.customerRent?.years &&
                        userEndOrder?.bookingInfo?.customerRent?.months >= 0 &&
                        userEndOrder?.bookingInfo?.customerRent?.days >= 0)
          ...
          <div className="text-left mt-5">
            <p>Terms:</p>
            <p className="font-medium">Please Read All Terms and Conditions</p>
          </div>
        </div>
      </div>
      {/* Invoice Footer */}
      ...
      <div className="mt-3 px-5">
        ...
        <p>
          2.Cancellation Policy: Cancellations made [X days/hours] prior to the
          check-in date will receive a full refund.
        </p>
        <p>
...
export default InvoiceForMobile;
