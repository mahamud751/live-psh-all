    ...
    <div className="md:ps-20 sm:ps-0 md:pr-32 sm:pr-0 accourding-part">
      ...
      <Accordion open={open === 1}>
        ...
        <AccordionBody className="md:pr-40 sm:pr-0">
          PSH is a community-focused property technology company. We strive to
          improve the quality of life in big cities for thousands of members of
          the PSH community by making the process of renting a residence easier
          and hassle-free through the Coliving lifestyle. PSH's property
          management services which prioritize design and cover all aspects are
          also strengthened by technological support, so that we can easily
          fulfill all urban living needs. With a focus on community, comfort and
          positive experiences, we continue to innovate to provide a better
      ...
      <Accordion open={open === 2}>
        ...
        <AccordionBody className="md:pr-40 sm:pr0">
          Coliving is a shared residence occupied by a group of people
          (community) who have something in common. The residents mingle and
          interact with each other in activities such as eating together or just
          chatting in the shared sitting room. This interaction can also
          continue in the form of joint work areas or other collective
          activities.
        </AccordionBody>
      </Accordion>
      <Accordion open={open === 3}>
        ...
        <AccordionBody className="md:pr-40 sm:pr0">
          1.You will be part of the community <br />
          2.You can enjoy privacy but still have opportunities for socialization{" "}
          <br />
          3.By sharing a place to live, we can help the environment a little{" "}
          <br />
          4.Five star facilities at lower prices <br />
          5.Comfortable, hassle-free living because laundry and cleaning
      ...
      <Accordion open={open === 11}>
        ...
        <AccordionBody className="md:pr-40 sm:pr0">
          Yes, PSH also provides apartment housing types. Please check
          https://psh.com.bd/ for more information.
        </AccordionBody>
      </Accordion>
      ...
      <Accordion open={open === 14}>
        ...
        <AccordionBody className="md:pr-40 sm:pr0">
          All furniture is available and ready to use. You just have to bring a
          suitcase of clothes.
        </AccordionBody>
      </Accordion>
    </div>
