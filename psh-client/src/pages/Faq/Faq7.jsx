    ...
    <div className="md:ps-20 sm:ps-0 md:pr-32 sm:pr-0 accourding-part">
      ...
      <Accordion open={open === 1}>
        <AccordionHeader onClick={() => handleOpen(1)} className="">
          <div className="flex justify-between ">
            <p className="text-sm">What is PSH koin?</p>
        ...
        <AccordionBody className="md:pr-40 sm:pr-0">
          PSH koin is a loyalty program from PSH. Currently, PSH koin is
          developing a new concept. However, no need to worry, your current
          Rukoin will not expire until the end of next year.
        </AccordionBody>
      </Accordion>
      <Accordion open={open === 2}>
        ...
        <AccordionBody className="md:pr-40 sm:pr0">
          The use of referral codes is temporarily suspended until this program
          returns with a new concept.
        </AccordionBody>
      </Accordion>
    </div>
  );
